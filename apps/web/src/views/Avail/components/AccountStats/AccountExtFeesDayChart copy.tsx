  ...
  const chartData = useMemo(() => {
    ...
    const datas = data?.accountDayData?.nodes?.map((rawData: any) => {
      ...
      return {
        ...
        totalFeeAvail: Number(rawData?.totalFees),
        totalFeeAvailF: new BigNumber(rawData?.totalFees).toFormat(4),
    ...
    <div className="h-full w-full row-span-2 ">
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Bar dataKey="totalFeeAvail" fill="url(#colorUv)" radius={10}></Bar>
          <YAxis
