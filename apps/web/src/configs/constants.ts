...
export const ETHERSCAN_LINK = ETHERSCAN_URL;
export const wagmiconfig = createConfig({
  chains: [mainnet, sepolia],
  transports: {
    [mainnet.id]: http(ETHEREUM_RPC_URL, { batch: true }),
...
export const ADDRESS_BOOK: AddressBook = {
  ...
  "0xc1b634853cb333d3ad8663715b08f41a3aec47cc": {
    ...
    l2beatProjectDataUrl: joinUrl(
      L2BEAT_RAW_DATA_BASE_URL,
      "projects/layer2s/arbitrum.json",
    ),
  },
  "0x6887246668a3b87f54deb3b94ba47a6f63f32985": {
    ...
    l2beatProjectDataUrl: joinUrl(
      L2BEAT_RAW_DATA_BASE_URL,
      "projects/layer2s/optimism.json",
    ),
  },
  "0x2c169dfe5fbba12957bdd0ba47d9cedbfe260ca7": {
    ...
    l2beatProjectDataUrl: joinUrl(
      L2BEAT_RAW_DATA_BASE_URL,
      "projects/layer2s/starknet.json",
    ),
  },
  ...
  "0xfbc0dcd6c3518cb529bc1b585db992a7d40005fa": {
    ...
    l2beatProjectDataUrl: joinUrl(
      L2BEAT_RAW_DATA_BASE_URL,
      "projects/layer2s/zklighter.json",
    ),
  },
};
