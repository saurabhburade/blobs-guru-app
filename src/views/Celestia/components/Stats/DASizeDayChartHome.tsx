...
import { CELESTIA_DAY_DATAS_WITH_DURATION_QUERY } from "@/lib/apollo/queriesCelestia";
...
export default function DASizeDayChartHome({ duration }: { duration: number }) {
  const { data, loading } = useQuery(CELESTIA_DAY_DATAS_WITH_DURATION_QUERY, {
    variables: {
      duration: duration,
    },
